...
public class SmartOffsideBlue extends AutoProgram {
    ...
    protected void defineSteps() {
        ...
        group6.addStep(new SwervePathFollowerStep("EtoD", swerve));
        ...
        // addStep(new SwervePathFollowerStep("GrabCOffside", swerve));
        // AutoParallelStepGroup group5 = new AutoParallelStepGroup();
        // group5.addStep(new SwervePathFollowerStep("ScoreCOffside", swerve));
