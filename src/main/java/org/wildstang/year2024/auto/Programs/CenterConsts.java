...
public class CenterConsts {

    public static final double startingGyroRed = 180.1;
    public static final double startingGyroBlue = 179.9;

    public static final double firstShot = 175;
    public static final double secondShot = 88;
    ...
    public static final int slideDelay2 = 900;
    public static final int slideDelay3 = 700;
