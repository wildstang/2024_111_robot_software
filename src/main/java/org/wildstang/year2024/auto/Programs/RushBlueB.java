...
public class RushBlueB extends AutoProgram {
    ...
    protected void defineSteps() {
        ...
        addStep(new AutoSetupStep(1.5, 7.0, 180.0, Alliance.Blue));
        ...
        group1.addStep(new SwervePathFollowerStep("RushAB", swerve));
        ...
        group3.addStep(new SwervePathFollowerStep("RushBB", swerve));
        ...
        group4.addStep(new SwervePathFollowerStep("RushCB", swerve));
        ...
        addStep(new SwervePathFollowerStep("RushDB", swerve));
        addStep(new AutoStepDelay(500));
        addStep(new ShootSpeakerStep());
        addStep(new AutoStepDelay(400));
