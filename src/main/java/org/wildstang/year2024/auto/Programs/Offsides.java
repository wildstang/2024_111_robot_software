...
public class Offsides extends AutoProgram {
    ...
    protected void defineSteps() {
        ...
        group1.addStep(new SwervePathFollowerStep("GrabE Offside", swerve, isBlue));
        ...
        group2.addStep(new SwervePathFollowerStep("ScoreE Offside", swerve, isBlue));
        ...
        // grab middle piece D
        addStep(new SwervePathFollowerStep("GrabD Offside", swerve, isBlue));

        //score middle piece D
        AutoParallelStepGroup group4 = new AutoParallelStepGroup();
        group4.addStep(new SwervePathFollowerStep("ScoreD Offside", swerve, isBlue));
        ...
        addStep(new SwervePathFollowerStep("GrabC Offside", swerve, isBlue));
        AutoParallelStepGroup group5 = new AutoParallelStepGroup();
        group5.addStep(new SwervePathFollowerStep("ScoreC Offside", swerve, isBlue));
