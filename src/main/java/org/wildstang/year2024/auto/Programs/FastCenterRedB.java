...
public class FastCenterRedB extends AutoProgram{
    ...
    protected void defineSteps() {
        ...
        addStep(new AutoSetupStep(1.32, 5.55, 180.0, Alliance.Red));
        ...
        group1.addStep(new SwervePathFollowerStep("CenterBA", swerve));
        ...
        addStep(new SwervePathFollowerStep("CenterBB", swerve));
