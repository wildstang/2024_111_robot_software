...
public class WsPV {
    ...
    public boolean canSeeBlueSpeakerOrAmp() {
        if(getAprilTagID() == 6 && getAprilTagID() == 7 && getAprilTagID() == 8)
            return true;
        else
            return false;
    }
    public boolean canSeeRedSpeakerOrAmp() {
        if(getAprilTagID() == 3 && getAprilTagID() == 4 && getAprilTagID() == 5)
            return true;
        else
            return false;
    }
