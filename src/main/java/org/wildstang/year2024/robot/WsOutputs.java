...
public enum WsOutputs implements Outputs {
    ...
    //make sure to change this name from "Module 4 Angle Motor" to something describing it, as motors can't share names
    ARMNEO("Module 4 Angle Motor", new WsSparkConfig(CANConstants.ARMNEO, WsMotorControllers.SPARK_MAX_BRUSHLESS)),
